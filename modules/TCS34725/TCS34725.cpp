 ...
 *  @param  value
 */
void AdafruitTCS34725::write8(uint8_t reg, uint32_t value) {
    uint8_t buffer[2] = {static_cast<uint8_t>(TCS34725_COMMAND_BIT | reg),
 ...
 *  @return value
 */
uint8_t AdafruitTCS34725::read8(uint8_t reg) {
 ...
 *  @return value
 */
uint16_t AdafruitTCS34725::read16(uint8_t reg) {
 ...
 *          Gain
 */
[[maybe_unused]] AdafruitTCS34725::AdafruitTCS34725(uint8_t it, tcs34725Gain_t gain) {
 ...
 *          Integration Time
 */
void AdafruitTCS34725::setIntegrationTime(uint8_t it) {
 ...
 */
void AdafruitTCS34725::setGain(tcs34725Gain_t gain) {
    if (!_tcs34725Initialised)
        begin();
 ...
 *          Clear channel value
 */
void AdafruitTCS34725::getRawData(
 ...
 *          Clear channel value
 */
[[maybe_unused]] void AdafruitTCS34725::getRawDataOneShot(uint16_t *r, uint16_t *g, uint16_t *b,
                                                          uint16_t *c) {
    if (!_tcs34725Initialised)
        begin();
 ...
 */
[[maybe_unused]] void AdafruitTCS34725::getRGB(float *r, float *g, float *b) {
    ...
    *r = static_cast<float>(red) / static_cast<float>(sum) * 255.0f;
    *g = static_cast<float>(green) / static_cast<float>(sum) * 255.0f;
 ...
 */
[[maybe_unused]] uint16_t AdafruitTCS34725::calculateColorTemperature(
        uint16_t r, uint16_t g, uint16_t b) {
    float X, Y, Z; /* RGB to XYZ correlation      */
    float xc, yc;  /* Chromatic co-ordinates   */
    ...
    /* 2. Calculate the chromatic co-ordinates      */
    xc = (X) / (X + Y + Z);
    yc = (Y) / (X + Y + Z);
 ...
 *  @return Color temperature in degrees Kelvin
 */
[[maybe_unused]] uint16_t AdafruitTCS34725::calculateColorTemperature_dn40(
        uint16_t r, uint16_t g, uint16_t b, uint16_t c) const {
 ...
 *  @return Lux value
 */
[[maybe_unused]] uint16_t AdafruitTCS34725::calculateLux(uint16_t r, uint16_t g, uint16_t b) {
    float illuminance;
 ...
 */
[[maybe_unused]] void AdafruitTCS34725::setInterrupt(boolean i) {
 ...
 *          High limit
 */
[[maybe_unused]] void AdafruitTCS34725::setIntLimits(uint16_t low, uint16_t high) {
