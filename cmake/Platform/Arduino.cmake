...
#=============================================================================#
#
#   generators firmware and libraries for Arduino devices
#
...
#=============================================================================#
#
#   generators firmware and libraries for AVR devices
...
#  programmers.txt the programmer definitions.
#
...
#
#  For every user setting found a generator setting is created of the following format:
#
#      ${PREFIX}${SUFFIX}
#
...
#
#        VAR_NAME    - Variable which will hold the generated library names
#        BOARD_ID    - Board ID
...
function(setup_arduino_library VAR_NAME BOARD_ID LIB_PATH COMPILE_FLAGS LINK_FLAGS)
    ...
    if (NOT TARGET ${TARGET_LIB_NAME})
        ...
        # Target already exists, skipping creating
        list(APPEND LIB_TARGETS ${TARGET_LIB_NAME})
    endif ()
    if (LIB_TARGETS)
...
#
# Creates a target (${TARGET_NAME}-serial) for launching the serial terminal.
#
#=============================================================================#
...
#
#  These variables are generated in order to be able to  programmatically traverse
...
#
# Print the entry settings (see load_arduino_style_settings()).
#
#=============================================================================#
...
#
# Print list settings and names (see load_arduino_style_settings()).
#=============================================================================#
...
function(GENERATE_CPP_FROM_SKETCH MAIN_SKETCH_PATH SKETCH_SOURCES SKETCH_CPP)
    ...
    foreach (SKETCH_SOURCE_PATH ${SKETCH_SOURCES} ${MAIN_SKETCH_PATH})
        ...
        foreach (SKETCH_PROTOTYPE ${SKETCH_PROTOTYPES})
            ...
            # " else if(var == other) {" shouldn't be listed as prototype
...
#
# Ensure the specified variables are not empty, otherwise a fatal error is emitted.
#=============================================================================#
...
if (NOT ARDUINO_FOUND AND ARDUINO_SDK_PATH)
    ...
    if (NOT CMAKE_OBJCOPY)
        ...
        set(CMAKE_OBJCOPY ${AVROBJCOPY_PROGRAM} CACHE PATH "OBJCOPY Program for firmware conversion in hex")
